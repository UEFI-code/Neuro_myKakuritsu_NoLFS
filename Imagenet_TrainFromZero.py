...
parser.add_argument('-a', '--arch', metavar='ARCH', default='Kakuritsu',
                    help='model architecture: Kakuritsu and Dropout, with ResNet152')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    elif args.arch == 'try_resnet_hack':
        print('Load ResNet152 in hacked torchvision')
        model = torchvision_resnet_hack.resnet152(pretrained = True)
